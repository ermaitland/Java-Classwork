...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public Employee searchEmployeeById(int empId) {
		//Optional class : polished way of dealing with null and orElse is the method of Optional Class, Optional Class introduced in 1.8
	...
	@Override
	public Employee incrementEmployeeSalary(int empId, int incAmount) {
		Employee employee=searchEmployeeById(empId);
		if(employee!=null) {
			employee.setSalary(employee.getSalary()+incAmount);
