...
public class LibraryUserInterfaceImpl implements LibraryUserInterface {
	...
	//6) remove decolration 
	private LibraryBusinessLogicImpl businessLogic;
	//=new LibraryBusinessLogicImpl();
	
	//7) Make constructor/setter - this time setter just to show
	...
	public void showMenu() {
		System.out.println("1. List all DVDs in collection");
