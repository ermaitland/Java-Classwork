...
public class EmployeeUserInteracelmpl implements EmployeeUserInterface {
	...
	private EmployeeBussienssLogicImpl bussinessLogic;

	@Autowired
	public EmployeeUserInteracelmpl(@Qualifier("service") EmployeeBussienssLogicImpl bussinessLogic) {
		super();
		this.bussinessLogic = bussinessLogic;
	}
//	@Autowired
//	public void setBussinessLogic(@Qualifier("service") EmployeeBussienssLogicImpl bussinessLogic) {
//		this.bussinessLogic = bussinessLogic;
//	}
